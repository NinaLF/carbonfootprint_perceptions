...
data.regression.weights.footprint <- data.regression.weights.long %>% select(participant.label, footprint.travel.car, footprint.flying, footprint.electricity, footprint.diet,   footprint.recycling, footprint.regional )
data.regression.weights.footprint <- unique(data.regression.weights.footprint)

data.regression.weights.footprint.long <- pivot_longer(data.regression.weights.footprint, footprint.travel.car:footprint.regional,  names_to = "behavior", values_to = "reported.behavior")
...
plot_model(complete.model.impact.perc.beh)
```
