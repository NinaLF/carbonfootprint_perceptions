...
data.accuracy.score.excl <- data.accuracy.score %>% filter(!estimate<0) 
...
### Predicting Accuracy 
```{r}
model.accuracy2 <- lm(estimate ~ age + gender + education + income +
                       cc_concern.mean + conservative_liberal + total_co2,
                     data=data.accuracy.score)
tab_model(model.accuracy2)
model.accuracy2.excl <- lm(estimate ~ age + gender + education + income +
                       cc_concern.mean + conservative_liberal + total_co2,
...
```{r}
ggplot(data.accuracy.score.excl, aes(x=estimate, fill=rel_cc_concern.mean.f, alpha=.3)) +
...
```{r}
ggplot(data.accuracy.score.excl, aes(x=estimate, fill=income)) +
...
```{r}
model.support.accuracy2 <- lm(policy.support.total ~ estimate+ conservative_liberal +
                               age + gender + education + income +
                               cc_concern.mean ,
                             data=data.accuracy.score)
tab_model(model.support.accuracy2)

model.support.accuracy.excl <- lm(policy.support.total ~ estimate+ conservative_liberal +
                                  age + gender + education + income +
                                  cc_concern.mean ,
                              data=data.accuracy.score.excl)
tab_model(model.support.accuracy.excl)

model.support.accuracy2.mod <- lm(policy.support.total ~ estimate*rel_cc_concern.mean+ conservative_liberal+
                               age + gender + education + income ,
                             data=data.accuracy.score.excl)
...
ggplot(data.accuracy.score.excl, aes(x=policy.support.total, fill=rel_cor.f)) +
  geom_density(alpha=.5) +  labs(alpha=NULL, fill="accuracy", y="policy support") +
  theme_minimal() +
  scale_fill_manual(values=c(  "#a50000", "#F6BE00", "#2F8D06"))
...
model.behavior.accuracy2 <- lm(total_co2 ~ estimate + cc_concern.mean+ conservative_liberal +
                                age + gender + education + income ,
                              data=data.accuracy.score)
tab_model(model.behavior.accuracy2)

model.behavior.accuracy2.excl <- lm(total_co2 ~ estimate + cc_concern.mean+ conservative_liberal +
                                   age + gender + education + income ,
                               data=data.accuracy.score.excl)
...
ggplot(data.accuracy.score.excl, aes(x=estimate, fill=rel_total_co2.f, alpha=.3)) +
...
model.behavior.accuracy1.car <- lm(footprint.travel.car ~   cc_concern.mean+ conservative_liberal + estimate + # policy+
                                age + gender + education + income ,
                              data=data.accuracy.score.excl)
model.behavior.accuracy1.fly <- lm(footprint.flying ~   cc_concern.mean+ conservative_liberal  + estimate + # policy+
                                age + gender + education + income ,
                              data=data.accuracy.score.excl)

model.behavior.accuracy1.diet <- lm(footprint.diet ~    cc_concern.mean+  conservative_liberal  + estimate +  # policy+
                                age + gender + education + income ,
                              data=data.accuracy.score.excl)

model.behavior.accuracy1.elec <- lm(footprint.electricity ~  +cc_concern.mean+ conservative_liberal  + estimate +  # policy+
                                age + gender + education + income ,
                              data=data.accuracy.score.excl)

model.behavior.accuracy1.reg <- lm(footprint.regional ~  cc_concern.mean+ conservative_liberal  + estimate +  # policy+
                                age + gender + education + income ,
                              data=data.accuracy.score.excl)
...
```{r}
complete.model <- lmer(policy.support ~ regression.weight + reported.behavior +
                            cc_concern.mean+ conservative_liberal +
                            gender + age + income + education  +
                         (1|participant.label),
                          data=data.regression.total)

tab_model(complete.model)
