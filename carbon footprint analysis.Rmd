...
data.importance.weights.t <- data.importance.weights %>% rename(footprint=footprint.travel.car)
...
data.part.worths.t <- data.part.worths %>% rename(footprint=footprint.travel.car)
...
data.regression.weights.footprint.long$behavior <- factor(data.regression.weights.footprint.long$behavior, 
                                                         levels=c( "footprint.travel.car", "footprint.diet", "footprint.electricity","footprint.flying", "footprint.recycling", "footprint.regional" ),
                                                         labels=c("commute", "diet", "electricity", "flying", "recyling", "regional") )  
