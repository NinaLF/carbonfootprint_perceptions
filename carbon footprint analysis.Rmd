...
### Flying
```{r}
tab_model(model.weight.flying.iw)

```

### Diet
```{r}
tab_model(model.weight.diet.iw)
```

### Electricity
```{r}

tab_model(model.weight.elec.iw)
```


### Transport
```{r}
tab_model(model.weight.transport.iw)
...
```{r}
tab_model(model.weight.regional.iw)
```

### Recycling
```{r}
tab_model(model.weight.recycle.iw)
```
