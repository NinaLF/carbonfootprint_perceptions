...
complete.model.behavior <- lmer(reported.behavior ~ policy.support + regression.weight +
                            cc_concern.mean+ conservative_liberal  + impact + domain +
                            gender + age + income + education  +
                         (1|participant.label) + (1 |behavior) ,
                          data=data.regression.total)
...
plot_model(complete.model.behavior, type="emm",terms=c("regression.weight")) +
  labs(x="regression weight", y="reported behavior")
...
complete.model.behavior.impact <- lmer(reported.behavior ~ policy.support + regression.weight*impact +
                            cc_concern.mean+ conservative_liberal  +
                            gender + age + income + education  +
                         (1|participant.label) + (1 |behavior) ,
                          data=data.regression.total)
...
complete.model.policy<- lmer(policy.support ~ regression.weight + reported.behavior +
                            cc_concern.mean+ conservative_liberal +
                            gender + age + income + education  +
                         (1|participant.label) + (1|behavior) ,
                          data=data.regression.total)
